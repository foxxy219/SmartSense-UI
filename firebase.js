...
import { getDatabase, ref, get, child, update, remove, onValue } from "https://www.gstatic.com/firebasejs/9.9.4/firebase-database.js";
...
var getdata = get(child(dbRef, `/`)).then((snapshot) => {
  if (snapshot.exists()) {
    return snapshot.val();
  } else {
